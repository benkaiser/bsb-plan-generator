# BSB Bible Reading Plan Generator

A client-side static web application to generate custom Bible reading plans as EPUB files using the Berean Standard Bible (BSB) source files.
...
- \`src/app.js\`: Main Preact application logic and EPUB generation.
